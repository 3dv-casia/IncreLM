...
def parse_config():
    ...
    arg_parser.add_argument('-c', '--config_file', type=str, default='cfgs_linemap/eval/tnt.yaml', help='config file')
    arg_parser.add_argument('--default_config_file', type=str, default='cfgs_linemap/eval/default.yaml', help='default config file')
