...
from runners_linemap.hypersim.Hypersim import Hypersim
...
def main():
    ...
    eval_hypersim(cfg, lines, dataset_hypersim, cfg["scene_id"],
                  cam_id=cfg["cam_id"], vis_err_th=visualize_error_threshold)
