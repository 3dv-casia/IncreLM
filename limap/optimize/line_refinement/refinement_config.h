    ...
    namespace line_refinement
    {
      ...
      public:
        RefinementConfig()
        {
          ...
          solver_options.max_num_iterations = 100; // the default is 100 in LIMAP
          ...
          solver_options.logging_type = ceres::PER_MINIMIZER_ITERATION; // PER_MINIMIZER_ITERATION, SILENT
