...
// include linemap
#include "linemap/pylinemap/bindings.cc"
void bind_linemap(py::module &);
...
namespace limap
{
  ...
  PYBIND11_MODULE(_limap, m)
  {
    ...
    // bind linemap as a submodule `_linemap` of `_limap`
    pybind11::module_ _linemap = m.def_submodule("_linemap");
    bind_linemap(_linemap);
  }
}
