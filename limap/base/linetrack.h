...
namespace limap
{
  ...
  public:
    ...
    LineTrack(const Line3d &line_, const std::vector<int> &image_id_list_, const std::vector<int> &line_id_list_, const std::vector<Line2d> &line2d_list_) : line(line_), image_id_list(image_id_list_), line_id_list(line_id_list_), line2d_list(line2d_list_) {}
