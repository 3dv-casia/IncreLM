...
namespace limap
{
  ...
  public:
    ...
    void set_to_default()
    {
      ...
      use_smartangle = false;
    }

    void print() const
    {
      std::cout << "LineLinker2dConfig::use_angle = " << use_angle
                << std::endl;
      std::cout << "LineLinker2dConfig::use_overlap = " << use_overlap
                << std::endl;
      std::cout << "LineLinker2dConfig::use_smartangle = " << use_smartangle
                << std::endl;
      std::cout << "LineLinker2dConfig::use_perp = " << use_perp
                << std::endl;
      std::cout << "LineLinker2dConfig::use_innerseg = " << use_innerseg
                << std::endl;
      std::cout << "LineLinker2dConfig::th_angle = " << th_angle
                << std::endl;
      std::cout << "LineLinker2dConfig::th_overlap = " << th_overlap
                << std::endl;
      std::cout << "LineLinker2dConfig::th_smartoverlap = " << th_smartoverlap
                << std::endl;
      std::cout << "LineLinker2dConfig::th_smartangle = " << th_smartangle
                << std::endl;
      std::cout << "LineLinker2dConfig::th_perp = " << th_perp
                << std::endl;
      std::cout << "LineLinker2dConfig::th_innerseg = " << th_innerseg
                << std::endl;
    }
  };
  ...
  public:
    ...
    bool check_reprojection_score(const Line2d &l1, const Line2d &l2) const;
    double compute_score(const Line2d &l1, const Line2d &l2) const;
    double compute_reprojection_score(const Line2d &l1, const Line2d &l2) const;
  ...
  private:
    ...
    bool check_connection_overlap_oneway(const Line2d &l1, const Line2d &l2) const;
    bool check_connection_perp(const Line2d &l1, const Line2d &l2) const;
    bool check_connection_perp_oneway(const Line2d &l1, const Line2d &l2) const;
    ...
    double compute_score_overlap_oneway(const Line2d &l1, const Line2d &l2) const;
    ...
    double compute_score_perp_oneway(const Line2d &l1, const Line2d &l2) const;
  ...
  public:
    ...
    void print() const
    {
      std::cout << "LineLinker3dConfig::use_angle = " << use_angle
                << std::endl;
      std::cout << "LineLinker3dConfig::use_overlap = " << use_overlap
                << std::endl;
      std::cout << "LineLinker3dConfig::use_smartangle = " << use_smartangle
                << std::endl;
      std::cout << "LineLinker3dConfig::use_perp = " << use_perp
                << std::endl;
      std::cout << "LineLinker3dConfig::use_innerseg = " << use_innerseg
                << std::endl;
      std::cout << "LineLinker3dConfig::use_scaleinv = " << use_scaleinv
                << std::endl;
      std::cout << "LineLinker3dConfig::th_angle = " << th_angle
                << std::endl;
      std::cout << "LineLinker3dConfig::th_overlap = " << th_overlap
                << std::endl;
      std::cout << "LineLinker3dConfig::th_smartoverlap = " << th_smartoverlap
                << std::endl;
      std::cout << "LineLinker3dConfig::th_smartangle = " << th_smartangle
                << std::endl;
      std::cout << "LineLinker3dConfig::th_perp = " << th_perp
                << std::endl;
      std::cout << "LineLinker3dConfig::th_innerseg = " << th_innerseg
                << std::endl;
      std::cout << "LineLinker3dConfig::th_scaleinv = " << th_scaleinv
                << std::endl;
    }
  };
